namespace SnapshotShaders.URP
{
    ...
    public class SepiaToneEditor : VolumeComponentEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("The SepiaTone effect must be added to your renderer's Renderer Features list.", MessageType.Error);
            }

            PropertyField(strength);
        }

        // Check the Forward Renderer and make sure the SepiaTone effect is attached.
        private bool CheckEffectEnabled()
        {
            ...
            {
                if (item?.GetType() == typeof(SepiaTone))
                {
                    return true;
                }
            }
